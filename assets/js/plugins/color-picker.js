jQuery(document).ready(function($){
    ...
    $color_list = [
        ...
        {color:'#350d6e',title:'Bluecw'},
        {color:'#00943f',title:'Greenry'},
        {color:'#0c2a8c',title:'Bluery'},
        {color:'#0a9308',title:'Greencw'},
        {color:'#0e76a8',title:'Bluelg'},
        {color:'#e91e63',title:'Red'}
  ...
  $(".color-picker-wrap input[type='color']").on("change",function(){
    ...
    if(self.parents('.color-picker-wrap').children(".color-picker").hasClass('cp-show')){
        ...
        self.parents('.color-picker-wrap').append('<small>Color: <code>'+self.val()+'</code></small>');
